#!/usr/bin/env python3
"""
Script para limpiar y migrar la base de datos RAG al nuevo formato vec0.
"""
...
from rag_engine.database import init_sqlite_vec

def clean_and_migrate():
    """Limpiar tablas vec0 existentes y migrar desde cero."""
    db_path = "rag_database.db"

    print(f"Limpiando y migrando {db_path} al formato vec0...")
    ...
    try:
        ...
        # Eliminar tablas vec0 si existen
        tables_to_drop = ["vector_store_vec0", "vector_store_metadata"]
